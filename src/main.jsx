...
function App() {
  ...
  const appState = { selectedEvent, pass, registerForEvent, scanPass, flash }
    ...
    <BrowserRouter>
      <header className="site-header">
        ...
        <div className="header-actions">
          <button className="ghost-button" onClick={() => flash('Login page comes after routing foundation.')}>Log in</button>
